...
public:
    ...
    std::string get_info() const override { return get_info() + " : " + std::to_string(m_cost_per_kg) + " per kg"; }
...
public:
    ...
    std::string get_info() const override { return get_info() + " : " + std::to_string(m_cost_per_one) + " per one"; }
